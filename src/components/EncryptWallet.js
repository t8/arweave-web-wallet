...
const EncryptWallet = ({change, handleUpload, encryptWallet,passWallet, classes}) => {
    return(
      <Grid container direction="column" justify="center" alignContent="center" alignContent="center" >
          ...
          <InputBase
            ...
            />
            <Button variant="contained" onClick={encryptWallet}>Confirm Encryption</Button>
      </Grid>
    )
  }
